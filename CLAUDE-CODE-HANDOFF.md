...
> Branch: `claude/add-channel-commands-TKUN7`
...
Branch `claude/add-channel-commands-TKUN7` adds channel command support, date enforcement, technical depth, and a set of new AI brief commands on top of the 2026-02-22 main hardening pass.
