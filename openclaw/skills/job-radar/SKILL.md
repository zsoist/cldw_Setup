...
- Do NOT include a manual token/cost footer — the gateway appends accurate usage data automatically.
...
Brave api: <n>   # include Brave segment only when Brave was used
```
